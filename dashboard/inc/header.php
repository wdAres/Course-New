         ...
         <div class="row py-2">
            ...
            <div class="col-2" style="min-height: calc(100vh - 65px)">
               <ul class="list-unstyled text-dark bg-white p-2 sidebar-custom">
                  ...
                  <li class="<?php echo $active == 'consultation' ? 'active' : ''; ?>">
                     <a href="consultation.php"><i class="fas fa-address-book"></i> Consultation form</a>
                  </li>
                  <li class="<?php echo $active == 'career' ? 'active' : ''; ?>">
                     <a href="career.php"><i class="fas fa-address-book"></i> Career Counselling</a>
                  </li>
                  <li class="<?php echo $active == 'hire' ? 'active' : ''; ?>">
                     <a href="hireform.php"><i class="fas fa-address-book"></i> Hire Form</a>
                  </li>
                  <li class="<?php echo $active == 'training' ? 'active' : ''; ?>">
                     <a href="trainingform.php"><i class="fas fa-address-book"></i> Coperate Training</a>
                  </li>
                  <li class="<?php echo $active == 'date' ? 'active' : ''; ?>">
                     <a href="date.php"><i class="fas fa-address-book"></i>Set Date</a>
                  </li>
               </ul>
            </div>