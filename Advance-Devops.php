      ...
      <div class="col-md-7 col-12 py-3">
        <div class="lt-side pt-md-5 mt-2 ms-md-4 me-md-5 d-flex justify-content-between flex-column">
          <h2 class="mb-3 main-heading text-white">
            Advance in DevOps - <span class="">Job</span> Guarantee Program
          </h2>

          <p class="mb-3 text-white">The Advance in DevOps Online Training Course at Course.so will give you a detailed
            overview of Github, CI/CD (Jenkins) Pipeline, Docker, Puppet, Grafana, AWS, and Ansible Configuration
            Management tool. During the training, you will get hands-on experience practicing and implementing the
            topics under the mentioned technologies.</p>

          <div class="mb-md-5 mb-0">
            <a href="" class="btn me-md-2 me-0 mb-3 mb-md-0">Apply Now</a>
            <a href="" class="btn">Download Brochure</a>
          </div>
        </div>
      </div>
      <div class="col-md-5 col-12 first-sec-form py-3">
        <div class="rt-side">
    ...
    <div class="top">
      <div class="row top-card">
        <div class="col-md-3 col-12 card-body">
          ...
          <p class="head">Learning Format</p>
        ...
        <div class="col-md-3 col-12 card-body">
          ...
          <p class="sub-head">6 Months</p>
        </div>
        <div class="col-md-3 col-12 card-body">
          <img src="./assets/New Job.png" alt="" class="second-sec-top-img" />
          <p class="head">Guaranteed</p>
          <p class="sub-head">Placement Assistance</p>
        </div>
        <div class="col-md-3 col-12 card-body">
          <img src="./assets/Cash in Hand.png" alt="" class="second-sec-top-img" />
          <p class="head">No Cost EMI Starts</p>
          <p class="sub-head">at ₹8,000/month*</p>
        </div>
      </div>
    </div>
    <div class="bottom row d-flex justify-content-evenly pt-5">
      <div class="col-4">
...
<section class="main-body-sec">
  <nav id="nav" class="navbar navbar-template navbar-light bg-white">
      ...
      <div class="container">
        <div class="row mt-4">
          <div class="col-md-7 col-12">
            ...
            <p class="">A year of experience in any programming language, as well as a fundamental understanding of
              Linux and networking concepts, qualifies a candidate for this course. If you are well-versed in the
              fundamentals of DevOps, you will have an advantage.</p>
            <div class="about-program-card p-4">
              <h5 class="ms-3 mb-4 lightgreen">Key Highlights</h5>
              <div class="row">
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>190 hours will be provided</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>Live interactiong learning , 190 hours will be provided</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>10+ projects and exercises</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                ...
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>100% Job Guarantee within 6 Months of Course Completion</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                ...
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>Recorded videos of classes</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>1:1 with Industry Mentors</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>Soft Skills Essential Training</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>Dedicated Learning Managers</p>
                </div>
              </div>
            </div>
            <div class="program-adv mt-5">
              ...
              <ul>
                <li class="d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>
                    Receive an industry-recognized Certification in Cloud
                    Computing and DevOps from Course.so.
                  </p>
                </li>
                <li class="d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                ...
                <li class="d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>
                    Get your dream job in just 6 months from the completion of
                    the program.
                  </p>
                </li>
              </ul>
        ...
        <div class="career-sec-body" id="">
          ...
          <div class="row">
            ...
            <div class="col-12 col-md-6 career-transition-card-container">
              ...
              <div class="career-transition-card">
                <img src="./assets/Handshake.png" alt="" class="" /><span class="red">300+ Hiring Partners</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="container-fluid">
        <div class="row pt-5">
          ...
          <div class="col-md-7 col-12">
            ...
            <ul class="">
              <li class="d-flex">
                <img src="./assets/Ellipse 1.png" alt="" height="18px" class="mx-2 mt-1" />
                <p>IT Operations Professionals</p>
              </li>
              <li class="d-flex">
                <img src="./assets/Ellipse 1.png" alt="" height="18px" class="mx-2 mt-1" />
              ...
              <li class="d-flex">
                <img src="./assets/Ellipse 1.png" alt="" height="18px" class="mx-2 mt-1" />
                <p>DevOps Consultants</p>
              </li>
              <li class="d-flex">
                <img src="./assets/Ellipse 1.png" alt="" height="18px" class="mx-2 mt-1" />
                <p>Systems, Network, and Cloud Administrators</p>
              </li>
              <li class="d-flex">
                <img src="./assets/Ellipse 1.png" alt="" height="18px" class="mx-2 mt-1" />
                <p>Testing, Software Automation, and Security Professionals</p>
              </li>
              <li class="d-flex">
                <img src="./assets/Ellipse 1.png" alt="" height="18px" class="mx-2 mt-1" />
                <p>
          ...
          <div class="col-md-4 col-12 lady-img-first-bg">
            ...
            <img src="./assets/christina.png" alt="" class="lady-img" />
          </div>
        </div>
      </div>
    </section>
              ...
              <div class="card">
                <div class="card-header collapsed curriculum-topics" data-coursid="" id="master-curriculum-heading3"
                  ...
                  <p class="master-curriculum-accordion-headi-detail mb-0">
                    <span class="curriculum-time">190 Hours</span>
                    <span class="curriculum-module">10 Module</span>
                  </p>
                </div>
                <div id="master-curriculum-collapse3" class="collapse curriculum-answer"
                  ...
                  <div class="card-body card-body-vk-ip card-body-">
                    ...
                    <p>
                      <strong>Module 01</strong>&nbsp;– About DevOps<br />
                      <span><i class="fas fa-circle"></i>Introduction of Devops</span><br />
                      <span><i class="fas fa-circle"></i>History and objective of Devops</span><br />

                      <strong>Module 02</strong>&nbsp;– Linux<br />
                      <span><i class="fas fa-circle"></i>Get started with Red Hat Enterprise Linux</span><br />
                      <span><i class="fas fa-circle"></i>Access the command line</span><br />

                      <strong>Module 03</strong>&nbsp;– AWS<br />
                      <span><i class="fas fa-circle"></i>Design Resilient Architectures</span><br />
                      <span><i class="fas fa-circle"></i>Design High-Performing Architectures</span><br />

                      <strong>Module 04</strong>&nbsp;– GIT<br />
                      <span><i class="fas fa-circle"></i>GIT Features</span><br />
                      <span><i class="fas fa-circle"></i>Architecture of GIT – Working Dir, Staging Area,
                        Repository</span><br />

                      <strong>Module 05</strong>&nbsp;– Ansible<br />
                      <span><i class="fas fa-circle"></i>Introduce Ansible</span><br />
                      <span><i class="fas fa-circle"></i>Deploy Ansible</span><br />

                      <strong>Module 06</strong>&nbsp;– Docker & Certified Kubernetes Administration<br />
                      <span><i class="fas fa-circle"></i>Overview of Docker and Container</span><br />
                      <span><i class="fas fa-circle"></i>Operations in Docker</span><br />

                      <strong>Module 07</strong>&nbsp;– Terraform<br />
                      <span><i class="fas fa-circle"></i>Choosing a right Infrastructure as Code tool</span><br />
                      <span><i class="fas fa-circle"></i>Installing Terraform - Windows Users</span><br />

                      <strong>Module 08</strong>&nbsp;– Nagios<br />
                      <span><i class="fas fa-circle"></i>Introduction of Continuous Monitoring tool</span><br />
                      <span><i class="fas fa-circle"></i>Introduction of Nagios</span><br />

                      <strong>Module 09</strong>&nbsp;– Jenkins<br />
                      <span><i class="fas fa-circle"></i>Introduction of Continuous Integration</span><br />
                      <span><i class="fas fa-circle"></i>Introduction of Jenkins</span><br />

                      <strong>Module 10</strong>&nbsp;– Grafana<br />
                      <span><i class="fas fa-circle"></i>Introduction of Grafana</span><br />
                      <span><i class="fas fa-circle"></i>Installations and configuration of Grafana</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div id="master-faq-accordion" class="master-curriculum-minimum-height master-curriculum-maximum-height">
            <div class="card">
              ...
              <div id="master-faq-collapse1" class="curriculum-answer show">
                <div class="card-body">
                  <p>
                    You need to follow simple steps to enroll for this training program. Just click on ‘Enroll Now’,
                    fill in the
                    required details, and complete the payment process. After successful payment, you will get a
                    confirmation
                    email along with the details to access the course material.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="master-faq-collapse2" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    The instructors at Simplilearn are highly qualified professionals who have more than 10 years of
                    working and
                    teaching experience. A rigorous selection process is followed to recruit the instructors for this
                    training
                    program and only those who are able to demonstrate their thorough understanding of the subject are
                    selected.
                  </p>
                </div>
              </div>
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse3" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    A DevOps Engineer certification is basically a credential that demonstrates your
                    understanding of how to implement DevOps practices in an organization. It is one of the
                    best ways of validating your skills in continuous improvement, continuous deployment,
                    and expertise in using various DevOps tools like Jenkins, Docker, and Kubernetes.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
                ...
                What are career fairs and how frequently will they be conducted?

              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    IIMJobs conducts Job fairs or facilitates recruitment drives with top hiring companies. You will be
                    invited to at least 1 career fair. These career fairs will be conducted in cities, such as Mumbai,
                    Bengaluru, Pune, NCR-Delhi, Hyderabad, and Chennai.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    This service will be active for a period of six months from your certification date. This service
                    will be active for a period of six months from your certification date.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    DevOps Engineer is a key role. This role is assumed by a leader or someone who is responsible for
                    ensuring that the DevOps strategy is implemented in the end-to-end development of the product while
                    bringing about a positive difference in the environment. </p>
                  <p>

                    Anybody working in Operations or Development/Engineering teams can opt for a career in DevOps. To
                    become a DevOps Engineer, you may start your career as a Software Engineer/Developer, System
                    Administrator, Automation Test Engineer, or Operations Manager and then progress to become a Release
                    Manager, DevOps Test Engineer, Automation Expert, and finally a full-fledged DevOps Engineer. </p>
                  <p>

                    The DevOps Engineer Course is for those who seek to fast-track their career in the software
                    development industry. People working in the following roles will benefit the most from the DevOps
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    DevOps engineers are in high demand these days and companies prefer certified professionals who have
                    validated their skills in DevOps. You need to dedicate your efforts in completing this DevOps
                    Engineer training program, learn all the important concepts, and complete the industry projects to
                    prepare for the DevOps engineer certification.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    The high demand for DevOps certified professionals is witnessed in industrial sectors like Computer
                    Software, Information Technology & Services, Financial Services, and Consumer Electronics. SAP Labs,
                    Salesforce, Accenture, Amazon, TCS, and Capgemini are some of the renowned firms hiring certified
                    DevOps engineers
                  </p>
                </div>
              </div>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
                ...
                Do you provide any practice test as a part of this DevOps Master Certification?

              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>Yes, we provide a practice test as part of our DevOps Engineer certification program to help you
                    prepare for the actual certification exam. You can try this free DevOps Engineer Practice Test to
                    understand the type of questions that you would face in the actual exam and gain expertise in the
                    topics that are a part of the DevOps Engineer course.</p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>DevOps engineers love to collaborate on various platforms to exchange ideas and learn from each
                    other. That’s the whole point of DevOps, really. <br>

                    The most popular online platforms where DevOps engineers collaborate on include GitHub and
                    StackOverflow. Additionally, social media platforms such as Twitter, LinkedIn, Facebook, and Google+
                    are popular among DevOps engineers as they can follow like-minded individuals in relevant groups.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>Sure, a DevOps Engineer can be called a technical pro. DevOps Engineer is closely engaged in
                    complex processes leading to software development and its timely and successful deployment according
                    to the customer/project requirements.</p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>Compared to other operating systems like Windows and macOS, Linux is the most customizable and
                    allows downloading required DevOps tools in the simplest and fastest way. Given this, we can say
                    that Linux is highly relevant for DevOps as it imparts the flexibility and scalability required to
                    generate a dynamic software process. Using Linux, DevOps engineers can easily modify the software as
                    per their requirements and configure it to work for them.</p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>DevOps engineers aren't involved in coding from scratch. However, they must have a basic
                    understanding of coding and programming languages to keep a check on the software development
                    process. Knowledge of coding languages like Python, JavaScript, Ruby, C, and Go help DevOps
                    engineers perform their roles better.</p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>Freshers can easily get a job as a DevOps engineer once they gain all the required skills.
                    Simplilearn's DevOps master’s certification helps you attain the knowledge and skills you need, and
                    offers assistance in career development (India and the U.S. currently). Students taking this course
                    also get the opportunity for one-time participation in career fairs organized in Mumbai, Bengaluru,
                    Pune, NCR-Delhi, Hyderabad, and Chennai.</p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>In the recent past, DevOps Engineering has evolved as a popular career choice. Reports suggest that
                    the market demand for DevOps engineers is likely to increase by 46 percent in the upcoming years.
                    Also, an individual with a master's in DevOps engineering earns a median salary of ?6,74,202. Taking
                    these points into consideration, taking a Devops Engineering course and gaining your certification
                    is undoubtedly beneficial.</p>
                </div>
              </div>
            </div>
