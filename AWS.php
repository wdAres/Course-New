    ...
    <div class="row">
      <div class="col-md-7 col-12 py-3">
        <div class="lt-side pt-md-5 mt-2 ms-md-4 me-md-5 d-flex justify-content-between flex-column">
          ...
          AWS - <span class="">Job</span> Guarantee Program
          </h2>

          <p class="mb-3 text-white">The AWS Solutions Architect Certification training will enable you to design, plan and scale AWS implementations utilizing over 70 cloud computing services. The AWS course is aligned with the latest AWS exam featuring Amazon designated best practices. The AWS Solutions Architect Professional certification is one of the most complex exams available today. To successfully pass, the student will be required to have an abundance of technical knowledge, covering a vast amount of topics relating to architecture best practices within AWS.</p>
...
<section class="footer-sec bg-dark sec">
  <div class="container d-flex justify-content-center align-items-center text-light fs-1">
    Certification
  </div>
</section>
