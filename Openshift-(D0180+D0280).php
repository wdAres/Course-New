      ...
      <div class="col-md-7 col-12 py-3">
        <div class="lt-side pt-md-5 mt-2 ms-md-4 me-md-5 d-flex justify-content-between flex-column">
          <h2 class="mb-3 main-heading text-white">
            Openshift Administration (D0180 - D0280) - <span class="">Job</span> Guarantee Program
          </h2>

          <p class="mb-3 text-white">Introduction to Containers, Kubernetes, and Red Hat OpenShift (DO180) helps you
            build core knowledge in managing containers through hands-on experience with containers, Kubernetes, and the
            Red Hat® OpenShift® Container Platform. These skills are needed for multiple roles, including developers,
            administrators, and site reliability engineers. Openshift training provides a detailed understanding of the
            Openshift environment, how to install and administer the OpenShift Container Platform.</p>
...
<section class="main-body-sec">
      ...
      <div class="container">
        <div class="row mt-4">
          <div class="col-md-7 col-12">
            ...
            <p class="">Openshift training provides a detailed understanding of the Openshift environment, how to
              install and administer the OpenShift Container Platform. This hands-on, lab-based course shows you how to
              install, configure, and manage OpenShift clusters and deploy sample applications to further understand how
              developers will use the platform. OpenShift is a containerized application platform that allows
              enterprises to manage container deployments and scale their applications using Kubernetes.</p>
              ...
              <div class="card">
                ...
                <div id="master-curriculum-collapse3" class="collapse curriculum-answer"
                  ...
                  <div class="card-body card-body-vk-ip card-body-">
                    ...
                    <p>
                      <strong>Module 01</strong>&nbsp;– Container Technology<br />
                      <span><i class="fas fa-circle"></i>Virtual Machine</span><br />
                      <span><i class="fas fa-circle"></i>Introduction of Podman, Container and Images</span><br />

                      <strong>Module 02</strong>&nbsp;– Containerized Services<br />
                      <span><i class="fas fa-circle"></i>Containerized Web Services</span><br />
                      <span><i class="fas fa-circle"></i>Containerized Database</span><br />

                      <strong>Module 03</strong>&nbsp;– Introduction Of Kubernetes<br />
                      <span><i class="fas fa-circle"></i>What is container orchestration?</span><br />
                      <span><i class="fas fa-circle"></i>Kubernetes</span><br />

                      <strong>Module 04</strong>&nbsp;– Introduction Of Openshift<br />
                      <span><i class="fas fa-circle"></i>Components of Openshift</span><br />
                      <span><i class="fas fa-circle"></i>Architecture of Openshift</span><br />

                      <strong>Module 05</strong>&nbsp;– OpenShift Installation<br />
                      <span><i class="fas fa-circle"></i>Full-Stack Automation</span><br />
                      <span><i class="fas fa-circle"></i>Pre-existing infrastructure</span><br />

                      <strong>Module 06</strong>&nbsp;– Verification & Cluster Troubleshooting<br />
                      <span><i class="fas fa-circle"></i>Openshift Console Management</span><br />
                      <span><i class="fas fa-circle"></i>Basic Application Deployment by S2l</span><br />

                      <strong>Module 07</strong>&nbsp;– Authentication and Authorization<br />
                      <span><i class="fas fa-circle"></i>Openshift User and Group</span><br />
                      <span><i class="fas fa-circle"></i>Authentication</span><br />

                      <strong>Module 08</strong>&nbsp;– Cluster Security<br />
                      <span><i class="fas fa-circle"></i>Secrets</span><br />
                      <span><i class="fas fa-circle"></i>ConfigMap</span><br />

                      <strong>Module 09</strong>&nbsp;– Buid and Deploy<br />
                      <span><i class="fas fa-circle"></i>Build</span><br />
                      <span><i class="fas fa-circle"></i>Deploy</span><br />

                      <strong>Module 10</strong>&nbsp;– Pod Scheduling<br />
                      <span><i class="fas fa-circle"></i>Region and Zones</span><br />
                      <span><i class="fas fa-circle"></i>Scheduler Policies</span><br />

                      <strong>Module 11</strong>&nbsp;– Limiting Resource Usage<br />
                      <span><i class="fas fa-circle"></i>Resource requests</span><br />
                      <span><i class="fas fa-circle"></i>Resource limits</span><br />

                      <strong>Module 12</strong>&nbsp;– Cluster & Application Scaling<br />
                      <span><i class="fas fa-circle"></i>Application Scaling</span><br />
                      <span><i class="fas fa-circle"></i>Hands-n Labs</span><br />

                      <strong>Module 13</strong>&nbsp;– Performing Cluster Update<br />
                      <span><i class="fas fa-circle"></i>Cluster Update</span><br />

                      <strong>Module 14</strong>&nbsp;– Managing a Cluster with the Web Console<br />
                      <span><i class="fas fa-circle"></i>Accessing the Openshift Web Console</span><br />
                      <span><i class="fas fa-circle"></i>Creating a project</span><br />

                      <strong>Module 15</strong>&nbsp;– Kubernetes Operators<br />
                      <span><i class="fas fa-circle"></i>Kubernetes default controls and objects</span><br />
                      <span><i class="fas fa-circle"></i>Custom Resource Definition (CRD)</span><br />

                      <strong>Module 16</strong>&nbsp;– Examining Cluster Metrics<br />
                      <span><i class="fas fa-circle"></i>Viewing Cluster Metrics</span><br />
                      <span><i class="fas fa-circle"></i>Viewing Project Metrics</span><br />

                      <strong>Module 17</strong>&nbsp;– Configuring OpenShift Networking Components<br />
                      <span><i class="fas fa-circle"></i>Introducing OpenShift Software-defined Networking</span><br />
                      <span><i class="fas fa-circle"></i>Services for Accessing Pods</span>
                    </p>
                  </div>
                </div>
              </div>
  ...
  <section class="scrollspy py-md-5 py-4" id="Projects">
    <div class="container">
      ...
      <p class="">
        Openshift training provides a detailed understanding of the Openshift environment, how to install and administer
        the OpenShift Container Platform. This hands-on, lab-based course shows you how to install, configure, and
        manage OpenShift clusters and deploy sample applications to further understand how developers will use the
        platform. OpenShift is a containerized application platform that allows enterprises to manage container
        deployments and scale their applications using Kubernetes. OpenShift provides predefined application
        environments and builds upon Kubernetes to provide support for DevOps principles such as reduced time to market,
        infrastructure-as-code, continuous integration (CI), and continuous delivery (CD).
      </p>
      <div class="pt-5">
          ...
          <div id="master-faq-accordion" class="master-curriculum-minimum-height master-curriculum-maximum-height">
            <div class="card">
              ...
              <div id="master-faq-collapse1" class="curriculum-answer show">
                <div class="card-body">
                  <p>
                    You can access the recording of the missed class through our LMS. We record each training session
                    and upload it after the session to our LMS which can be accessible to the students.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse3" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    You need good internet connectivity with a mobile/tab/laptop/system
                    installed with Zoom/Meet.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>Yes, you get two kinds of discounts. They are group discounts and referral discounts.
                  <ul>
                    <li>A group discount is offered when you join as a group of three or
                      more.</li>
                    <li>When you are referred by someone already enrolled for training, you
                      receive a referral discount.</li>
                  </ul>
                  </p>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
                I want to complete the training
                in a few days or a week? Is it possible?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>You can access the recording of the missed class through our LMS. We record each
                    training session and upload it after the session to our LMS which can be accessible to
                    the students.</p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>Yes, you get two kinds of discounts. They are group discounts and referral discounts.
                  <ul>
                    <li>A group discount is offered when you join as a group of three or more.</li>
                    <li>When you are referred by someone already enrolled for training, you receive a
                      referral discount.</li>
                  </ul>
                  </p>
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    We provide you with all the necessary resources and guidance to get certified with the relevant
                    software/technology vendor on your own.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    You will get a verifiable course completion certificate once you attend all the
                    sessions and successfully submit the assessments.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
                Can you help
                me with resume preparation?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    Yes, our experts help you draft the perfect resume that matches your desired job
                    roles. </p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
                How does your
                mock interviews process work?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    A mock interview is a unique program we offer to help you experience real-time
                    interviews.<br>Our expert connects with you, conducts an interview, and provides you
                    feedback and quick tips to improve your skills as needed. </p>
                </div>
              </div>
            </div>
          </div>
