      ...
      <div class="col-md-7 col-12 py-3">
        <div class="lt-side pt-md-5 mt-2 ms-md-4 me-md-5 d-flex justify-content-between flex-column">
          <h2 class="mb-3 main-heading text-white">
            RHCSA and AWS - <span class="">Job</span> Guarantee Program
          </h2>

          <p class="mb-3 text-white">
          The AWS Solutions Architect Certification training will enable you to design, plan and scale AWS implementations utilizing over 70 cloud computing services. It builds on the RHCSA certification by covering more advanced topics like security and installing standard enterprise networking (IP) services. Some popular programs is Red Hat certified system Administrators (RHCSA). 
          </p>
      ...
      <div class="container">
        <div class="row mt-4">
          <div class="col-md-7 col-12">
            ...
            <p class="">Red Hat Certified System Administrator (RHCSA) is an entry-level certification course that covers Linux essentials (RH124) and Linux administration (RH134). It focuses on fundamental skills in system administration, such as installing and configuring a Red Hat Enterprise Linux system and connecting it to a live network where network services are running. </p>
            <p>The AWS Solutions Architect Professional certification is one of the most complex exams available today. To successfully pass, the student will be required to have an abundance of technical knowledge, covering a vast amount of topics relating to architecture best practices within AWS. Each course was laid out to cover the specific domains that AWS defines and deems necessary to pass the exam successfully. </p>
            <div class="about-program-card p-4">
              ...
              <div class="row">
                <div class="col-md-6 col-12 py-2 d-flex">
                  ...
                  <p>90 hours will be provided</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>Live interactiong learning , 90 hours will be provided</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
              ...
              <div class="card ip-vk-cc-lc">
                <div class="card-header collapsed curriculum-topics" data-coursid="" id="master-curriculum-heading2"
                  ...
                  <p class="master-curriculum-accordion-headi-detail mb-0">
                    <span class="curriculum-time">45 Hours</span>
                    <span class="curriculum-module">21 Module</span>
                  </p>
                </div>
                <div id="master-curriculum-collapse2" class="collapse curriculum-answer"
                  ...
                  <div class="card-body card-body-vk-ip card-body-">
                    ...
                    <p>
                      <strong>Module 01</strong>&nbsp;– 1.Introduction to
                      RHEL<br />
                      ...
                      <span><i class="fas fa-circle"></i>Use of Grep</span>
                    </p>
                  </div>
                </div>
              </div>
              <div class="card">
                <div class="card-header collapsed curriculum-topics" data-coursid="" id="master-curriculum-heading3"
                  ...
                  <p class="master-curriculum-accordion-headi-detail mb-0">
                    ...
                    <span class="curriculum-module">5 Module</span>
                  </p>
                </div>
                <div id="master-curriculum-collapse3" class="collapse curriculum-answer"
                  ...
                  <div class="card-body card-body-vk-ip card-body-">
                    <h6><b>Outline for this course</b></h6>
                    <p>
                      <strong>Module 01</strong>&nbsp;– Design for Organizational Complexity<br />
                      <span><i class="fas fa-circle"></i>Determine cross-account authentication and access strategy for complex organizations</span><br />
                      <span><i class="fas fa-circle"></i>Determine how to design networks for complex organization</span><br />

                      <strong>Module 02</strong>&nbsp;– Design for New Solutions<br />
                      <span><i class="fas fa-circle"></i>Determine a solution design to ensure business continuity</span><br />
                      <span><i class="fas fa-circle"></i>Determine a solution design to meet performance objectives</span><br />

                      <strong>Module 03</strong>&nbsp;– Migration Planning<br />
                      <span><i class="fas fa-circle"></i>Select existing workloads and processes for potential migration to the cloud.</span><br />
                      <span><i class="fas fa-circle"></i>Determine a new cloud architecture for an existing solution.</span><br />

                      <strong>Module 04</strong>&nbsp;– Cost Control<br />
                      <span><i class="fas fa-circle"></i>Select a cost-effective pricing model for a solution.</span><br />
                      <span><i class="fas fa-circle"></i>Identify opportunities to reduce cost in an existing solution.</span><br />

                      <strong>Module 05</strong>&nbsp;– Continuous Improvement for Existing Solutions<br />
                      <span><i class="fas fa-circle"></i>Troubleshoot solution architectures</span><br />
                      <span><i class="fas fa-circle"></i>Determine a strategy to improve an existing solution for operational excellence</span>
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div id="master-faq-accordion" class="master-curriculum-minimum-height master-curriculum-maximum-height">
              ...
              <div id="master-faq-collapse2" class="curriculum-answer">
                <div class="card-body">
                  ...
                  The iimjobs.com Pro-Membership offers learners exclusive features that aren’t available to free members.
                    <ul>
                      <li>Dedicated career experts from IIMJobs will completely handhold learners to register on the portal, provide them tips and guidance to improve the profile and follow the right keywords.</li>
                      <li>Access to Insights: This helps them compare their application against other applications received for a similar job.</li>
                      <li>Improved visibility of your profile: your application gets promoted to the top of the applications.</li>
                      <li>Receive notification if the recruiter shortlists your application, you can chat with the recruiter directly and do the follow-ups on the application.</li>
                    </ul>
                  </p>
                </div>
              </div>
              ...
              <div id="master-faq-collapse3" class="curriculum-answer">
                <div class="card-body">
                  ...
                  To participate in the JobAssist Program you need to:
                    <ul>
                      <li>Be a graduate (Engineering or Equivalent)</li>
                      <li>Complete our Master Program successfully and earn a Master certificate upon completion</li>
                    </ul>
                  </p>
                </div>
              </div>
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  IIMJobs conducts Job fairs or facilitates recruitment drives with top hiring companies. You will be invited to at least 1 career fair. These career fairs will be conducted in cities, such as Mumbai, Bengaluru, Pune, NCR-Delhi, Hyderabad, and Chennai.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
                What happens in the Career Mentoring session?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
