      ...
      <div class="col-md-7 col-12 py-3">
        <div class="lt-side pt-md-5 mt-2 ms-md-4 me-md-5 d-flex justify-content-between flex-column">
          <h2 class="mb-3 main-heading text-white">
            RHCSA and RHCE - <span class="">Job</span> Guarantee Program
          </h2>

          <p class="mb-3 text-white">
            RHCE is a mid-to advanced-level certification course covering Linux networking and security (RH254). It builds on the RHCSA certification by covering more advanced topics like security and installing standard enterprise networking (IP) services. Some popular programs are Red Hat Certified Engineer (RHCE) and Red Hat certified system Administrators (RHCSA). To get RHCE, you should get certified as a Red Hat Certified System Administrator (RHCSA) first; the requirements to achieve are in the same order Red Hat Enterprise Linux Technical Overview. 
          </p>
        ...
        <div class="col-lg-10">
          ...
          <div id="master-faq-accordion" class="master-curriculum-minimum-height master-curriculum-maximum-height">
            <div class="card">
              ...
              Do I have to pay extra for certification?
              </h3>
              <div id="master-faq-collapse1" class="curriculum-answer show">
                <div class="card-body">
                  <p>
                  No, you do not have to pay anything extra for a certification because it is included in the course fee charged.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              Who is a Red Hat Certified Engineer (RHCE)?
              </h3>
              <div id="master-faq-collapse2" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  A RHCE (Red Hat Certified Engineer) is a RHCSA (Red Hat Certified System Administrator) who has acquired more abilities, skills and knowledge to work on Red Hat Enterprise Linux systems.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  RHCE is most suitable for Red Hat Certified Engineers, System Engineers, security administrators, red hat certified system administrators, and Linux system administrators.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
              How can I go for this exam?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  To be able to move RHCE exam, you need to first clear RHCSA exam (EX200).
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What is the RHCE exam like?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  RHCE exam or EX300 is a hands-on, practical exam which is set for the duration of 3.5 hours. No outside material is allowed and there is no internet access.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
              How long does it take to get the result back?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  It usually takes 3 US business days to get the result back.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What job opportunities can I explore after this course?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  Linux system admin, DevOps ansible engineer, system engineer and Linux tech support are some of the fields you can explore.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
              For how long is the RHCE certification valid?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  RHCE certificate is valid for 3 years, after which it can be updated. You get globally accredited, which means that no matter where you go in the world, your certification is valid.
                  </p>
                </div>
              </div>
            </div>
