    ...
    <div class="row">
      <div class="col-md-7 col-12 py-3">
        <div class="lt-side pt-md-5 mt-2 ms-md-4 me-md-5 d-flex justify-content-between flex-column">
          ...
          Google Cloud Platform (GCP) - <span>Job</span> Guarantee Program
          </h2>
      ...
      <div class="container">
        <div class="row mt-4">
          <div class="col-md-7 col-12">
            ...
            <p class="">
            This Course GCP certification training has been created by industry experts to help you learn the GCP. As part of the training, you will learn cloud computing essentials, various Google Cloud Platform (GCP) core infrastructure services and managing GCP services like storage, compute, database, networking, identity and access management, security services and more through real-world projects.
            </p>
        ...
        <div class="col-lg-10">
          ...
          <div id="master-faq-accordion" class="master-curriculum-minimum-height master-curriculum-maximum-height">
            ...
            <div class="card">
              ...
              Why should I learn GCP certification course from Course?
              </h3>
              <div id="master-faq-collapse2" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  This Course Google Cloud training gives you hands-on experience in working with the Google Cloud Platform that is used by some of the biggest corporations in the world. You will master the complete Google Cloud concepts and technologies and get hands-on experience in designing, managing, monitoring and securing the GCP using Google best practices.</p>
                  <p>In this GCP course, you will be working on real-time Google Cloud projects and step-by-step assignments that have high relevance in the corporate world, and the course curriculum is designed by industry experts. Upon the completion of the Google cloud platform course, you can apply for some of the best jobs in top MNCs around the world at top salaries. Course offers lifetime access to videos, course materials, 24/7 support and course material upgrading to the latest version at no extra fee. Hence, it is clearly a one-time investment in this Google cloud certification.</p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
              How to become a GCP-certified professional?
              </h3>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What is the ideal career path for a Google Cloud Architect?
              </h3>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What does the future hold for a Google Cloud Architect?
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              Is coding experience required to enroll in this certification course?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              Are GCP Certifications worth it in 2022?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What job can I get with a GCP certification?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What are the top companies hiring GCP-certified professionals?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              How much does one earn after getting this certification?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              Which certification is best? AWS Certification or Google Cloud Certification?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What are the ideal computer specs required to enroll in this course?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    Following are the minimum specs required: <br>
                    Hardware Requirements:
                    <ul>
                      <li>Memory – Minimum 4 GB RAM</li>
                      <li>Processor – Intel Core i3 CPU @2.00 GHz or later</li>
                      <li>Storage – 250 GB HDD/SDD or later</li>
                    </ul>
                    Software Requirements:
                      <ul>
                        <li>Operating System – Windows 7 or later / Ubuntu 14 or later</li>
                      </ul>
                  </p>
                </div>
              </div>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What are some useful and free Google Cloud resources?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              Does Course provide any other Google Cloud courses?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
            ...
            <div class="card">
              ...
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  Course is offering 24/7 query resolution, and you can raise a ticket with the dedicated support team at any time. You can avail of email support for all your queries. If your query does not get resolved through email, we can also arrange one-on-one sessions with our support team. However, 1:1 session support is provided for a period of 6 months from the start date of your course.
                  </p>
                </div>
              </div>
            </div>
