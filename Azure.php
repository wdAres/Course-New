    ...
    <div class="row">
      <div class="col-md-7 col-12 py-3">
        <div class="lt-side pt-md-5 mt-2 ms-md-4 me-md-5 d-flex justify-content-between flex-column">
          ...
          Azure - <span class="">Job</span> Guarantee Program
          </h2>

          <p class="mb-3 text-white">This course teaches IT Professionals how to manage their Azure subscriptions, secure identities, administer the infrastructure, configure virtual networking, connect Azure and on-premises sites, manage network traffic, implement storage solutions, create and scale virtual machines, implement web apps and containers, back up and share data, and monitor your solution.</p>
            ...
            <div class="about-program-card p-4">
              ...
              <div class="row">
                <div class="col-md-6 col-12 py-2 d-flex">
                  ...
                  <p>32 hours will be provided</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
                  <p>Live interactiong learning , 32 hours will be provided</p>
                </div>
                <div class="col-md-6 col-12 py-2 d-flex">
                  <img src="./assets/Ellipse 1.png" alt="" height="20px" class="mx-2 mt-1" />
            ...
            <div id="master-curriculum-accordion">
              ...
              <div class="card">
                <div class="card-header collapsed curriculum-topics" data-coursid="" id="master-curriculum-heading3"
                  ...
                  <h3 class="master-curriculum-accordion-heading">Azure</h3>
                  <p class="master-curriculum-accordion-headi-detail mb-0">
                    <span class="curriculum-time">32 Hours</span>
                    <span class="curriculum-module">11 Module</span>
                  </p>
                </div>
                <div id="master-curriculum-collapse3" class="collapse curriculum-answer"
                  ...
                  <div class="card-body card-body-vk-ip card-body-">
                    ...
                    <p>
                      <strong>Module 01</strong>&nbsp;– Identity<br />
                      <span><i class="fas fa-circle"></i>Azure Active Directory</span><br />
                      <span><i class="fas fa-circle"></i>Users and Groups</span><br />

                      <strong>Module 02</strong>&nbsp;– Governance & Compliance<br />
                      <span><i class="fas fa-circle"></i>Subscriptions and Accounts</span><br />
                      <span><i class="fas fa-circle"></i>Azure Policy</span><br />

                      <strong>Module 03</strong>&nbsp;– Azure Administration<br />
                      <span><i class="fas fa-circle"></i>Azure Resource Manager</span><br />
                      <span><i class="fas fa-circle"></i>Azure Portal and Cloud Shell</span><br />

                      <strong>Module 04</strong>&nbsp;– Virtual Networking<br />
                      <span><i class="fas fa-circle"></i>Virtual Networks</span><br />
                      <span><i class="fas fa-circle"></i>IP Addressing</span><br />

                      <strong>Module 05</strong>&nbsp;– Intersite Connectivity<br />
                      <span><i class="fas fa-circle"></i>VNet Peering</span><br />
                      <span><i class="fas fa-circle"></i>VPN Gateway Connections</span><br />

                      <strong>Module 06</strong>&nbsp;– Network Traffic Management<br />
                      <span><i class="fas fa-circle"></i>Network Routing and Endpoints</span><br />
                      <span><i class="fas fa-circle"></i>Azure Load Balancer</span><br />

                      <strong>Module 07</strong>&nbsp;– Azure Storage<br />
                      <span><i class="fas fa-circle"></i>Storage Accounts</span><br />
                      <span><i class="fas fa-circle"></i>Blob Storage</span><br />

                      <strong>Module 08</strong>&nbsp;– Azure Virtual Machines<br />
                      <span><i class="fas fa-circle"></i>Virtual Machine Planning</span><br />
                      <span><i class="fas fa-circle"></i>Creating Virtual Machines</span><br />

                      <strong>Module 09</strong>&nbsp;– Server less Computing<br />
                      <span><i class="fas fa-circle"></i>Network Routing and Endpoints</span><br />
                      <span><i class="fas fa-circle"></i>Azure Load Balancer</span><br />

                      <strong>Module 10</strong>&nbsp;– Data Protection<br />
                      <span><i class="fas fa-circle"></i>File and Folder Backups</span><br />
                      <span><i class="fas fa-circle"></i>Virtual Machine Backups</span><br />

                      <strong>Module 11</strong>&nbsp;– Monitoring<br />
                      <span><i class="fas fa-circle"></i>Azure Monitor</span><br />
                      <span><i class="fas fa-circle"></i>Azure Alerts</span>
          ...
          <div id="master-faq-accordion" class="master-curriculum-minimum-height master-curriculum-maximum-height">
            <div class="card">
              ...
              <div id="master-faq-collapse1" class="curriculum-answer show">
                <div class="card-body">
                  <p>
                  Microsoft Azure, earlier called Windows Azure, is a public cloud computing platform. It delivers computation, analytics, storage, networking, and other cloud services to businesses and individual professionals.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              ...
              What are the applications of Azure?
              </h3>
              <div id="master-faq-collapse2" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  Infrastructure services, mobile apps, web applications, cloud services, storage, backup, and recovery, data management, media services are some of the important applications of Microsoft Azure.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What are the components of Microsoft Azure?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  Compute, storage, database, integration services, content delivery network, Azure networking, monitoring and management services, web and mobile services are the important components of Microsoft Azure.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What will I learn from the Microsoft Azure Fundamentals MAZ900 Training course?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                    What will I learn from the Microsoft Azure Fundamentals MAZ900 Training course?During this Microsoft Azure Fundamentals MAZ900 training course, you will learn about the core Azure architectural components, Azure solutions, securing network connectivity in Azure, etc. You will also learn about the core Azure identity services, planning and managing costs, privacy, compliance and data protection standards in Azure, and various knowledgeable concepts to increase your calibre in the cloud computing field.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What will you learn from the Developing Solutions for Microsoft Azure MAZ204 Training course?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  During the Developing Solutions for Microsoft Azure MAZ204 Training course, you will obtain insights into creating an Azure Kubernetes Service (AKS) cluster, enabling push notifications for the application, etc. You will also learn about developing Azure functions using visual studio, implementing code that addresses singleton application instances, and various skill attaining concepts in Azure.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="card">
              <h3 class="card-header curriculum-topics">
              What are the benefits of Microsoft Azure for businesses?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  Perfect for small businesses and established enterprises, complements and expands the current IT infrastructure, leading the way with IaaS and PaaS, industry-specific applications, security, compliance, and disaster recovery are the main benefits of Microsoft Azure.
                  </p>
                </div>
              </div>
            </div>
            <div class="card">
              <h3 class="card-header curriculum-topics">
              Can The Knowledge Academy deliver the training to more than 1000 delegates of my company?
              </h3>
              <div id="master-faq-collapse4" class="curriculum-answer">
                <div class="card-body">
                  <p>
                  Yes, we have already trained over 1000 delegates from multiple internationally renowned organisations. In cases where the delegates are more, we provide training in groups.
                  </p>
                </div>
              </div>
            </div>
